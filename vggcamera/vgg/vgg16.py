...
class Vgg16():
    ...
    def get_batches(self, path, gen=image.ImageDataGenerator(), shuffle=True, batch_size=1, class_mode='categorical'):
        """
    ...
    def fit_data(self, trn, labels,  val, val_labels,  nb_epoch=1, batch_size=1):
        """
    ...
    def test(self, path, batch_size=1):
        """
